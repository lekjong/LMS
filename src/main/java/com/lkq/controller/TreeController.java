...
public class TreeController {
	...
	public String getMenu(HttpServletResponse response,ModelMap maptrv)throws Exception {
		...
		ResponseUtil.write(response, gson.toJson(treeList));
	     ...
	     //ModelMap maptrv =new ModelMap();
		    
		maptrv.put("treeList", treeList);
			
		return "/admin/common/left_menu";
